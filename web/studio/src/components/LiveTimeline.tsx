...
export function LiveTimeline({ events, criticalOnly, onInspectAction }: { events: StudioEvent[]; criticalOnly: boolean; onInspectAction: (actionId: string) => void }) {
  ...
  return (
    <div className="timeline">
      {visible.map((event) => {
        ...
        return (
          <button className="event-card" key={event.event_id} onClick={() => actionId && onInspectAction(actionId)}>
            <div>
